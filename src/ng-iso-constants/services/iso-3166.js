(function(angular) {
  ...
  angular.module('ngIsoConstants.services')
    .factory('ISO3166', function() {
      var service = {
        getCountryObjFromCountryCode: getCountryObjFromCountryCode,
        getCountryObjFromNumericString: getCountryObjFromNumericString,
      ...
      var _numericStringToCountryObj = {};
      var _alpha2ToCountryObj        = {};
      ...
      function getCountryObjFromNumericString(numericString) {
        if (!numericString) {
          return null;
        }
        var idx = _numericStringToCountryObj[numericString.toString()];
        if (idx >= 0) {
          return _countryObjs[idx];
        } else {
          return null;
